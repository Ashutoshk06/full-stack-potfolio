...
const Header = () => {
  ...
  return (
    <div className='main flex w-full h-screen m-10 overflow-hidden'>
      <motion.div className='md:w-full w-full'>
        <span className='block text-[2em] sm:text-[2.2em] md:text-[2.6em] lg:text-[3em] m-5 font-extrabold uppercase text-slate-500  w-[60%] sm:w-[70%] h-[30%] md:h-[30%] mb-2'>
          I am a <br />
